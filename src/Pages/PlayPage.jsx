...
import PosterPlay from '../components/Poster/PosterPlay';
                    ...
                    <div className="w-7/12 ">
                        ...
                        <div className="flex flex-wrap">
                            ...
                            <div className="w-1/2  md:w-1/3 my-3  lg:w-1/4">
                                <PosterPlay src="https://in.bmscdn.com/discovery-catalog/events/tr:w-400,h-600,bg-CCCCCC:w-400.0,h-660.0,cm-pad_resize,bg-000000,fo-top:ote-U3VuLCAxOSBTZXA%3D,ots-29,otc-FFFFFF,oy-612,ox-24/et00314534-ktzzmvqrht-portrait.jpg"
